      ...
      <div className="scholarship">
        <section className="presentation">
          <div>
            ...
            <p>
              Wikimedia Igbo under Wiki Mentor Africa Program and KALI Academy
              are teaming up to offer a fully-funded Programming 101 course for
        ...
        <section className="about">
          ...
          <div>
            ...
            <p>
              Kali Academy is a non-profit organization whose mission is to
              train the next generation of open-source developers within Africa.
            </p>
          </div>
        </section>
